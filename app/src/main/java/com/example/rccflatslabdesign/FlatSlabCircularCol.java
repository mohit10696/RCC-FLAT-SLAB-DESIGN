...
public class FlatSlabCircularCol extends AppCompatActivity {
    ...
    double size_of_col_dia = 500;
    double col_head_dia = 2 * size_of_col_dia;
    double live_load = 4.2;
    double floor_finish = 4;
    double height_of_col = 3.5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flat_slab_circular_col);
        ButterKnife.bind(this);

        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#f740a4")));
        getSupportActionBar().setTitle("RCC FLAT SLAB DESIGN (CIRCULAR COLUMN WITH DROP AND COLUMN HEAD)");
        calDepthOfSlab();
        Col_mid_stiff_Calculation();
        loadCalculation();
        stiffnessCalcuation();
        ...
        et_interior_longer_span.addTextChangedListener(new FlatSlabCircularCol.MyTextWatcher());
        et_interior_shorter_span.addTextChangedListener(new FlatSlabCircularCol.MyTextWatcher());
        et_size_of_col_dia.addTextChangedListener(new FlatSlabCircularCol.MyTextWatcher());
        et_live_load.addTextChangedListener(new FlatSlabCircularCol.MyTextWatcher());
        et_floor_finish.addTextChangedListener(new FlatSlabCircularCol.MyTextWatcher());
        et_height_of_col.addTextChangedListener(new FlatSlabCircularCol.MyTextWatcher());
    }
    ...
    private void initview() {
        ...
        tv_dl_for_longer_side.setText(String.valueOf(depth_of_drop_portion) + " mm");
    ...
    private void calDepthOfSlab() {
        ...
        thinkness_of_slab = 0.25 * Provide_overall_depth;
        ...
        depth_of_drop_portion = provide_depth_of_drop - (assume_theta / 2) - clear_cover;
    ...
    private void Col_mid_stiff_Calculation() {
        ...
        Log.e("3", "calDepthOfSlab: " + along_long_span_col_strips1);
        Log.e("3", "calDepthOfSlab: " + along_long_span_width_col);
        Log.e("3", "calDepthOfSlab: " + along_short_span_col_strips1);
        Log.e("3", "calDepthOfSlab: " + along_short_span_width_col);
        Log.e("3", "calDepthOfSlab: " + size_of_drop_length);
        Log.e("3", "calDepthOfSlab: " + size_of_drop_depth);
    }

    private void loadCalculation() {
        Self_weight = (((size_of_drop_length / 1000) * (size_of_drop_breadth / 1000) * (size_of_drop_depth / 1000)) + (((interior_longer_span * interior_shorter_span) - ((size_of_drop_length / 1000) * (size_of_drop_breadth / 1000))) * (Provide_overall_depth / 1000))) * (25 / (interior_longer_span * interior_shorter_span));
    ...
    private void stiffnessCalcuation() {
        ...
        along_longer_ks = (4 * 2 * 100000 * interior_shorter_span * 1000 * Math.pow(provide_depth_of_drop, 3)) / (interior_longer_span * 1000 * 12);
        ...
        along_shorter_ks = (4 * 1 * 2 * 100000 * interior_longer_span * 1000 * Math.pow(provide_depth_of_drop, 3)) / (interior_shorter_span * 1000 * 12);
        along_shorter_alphac = Math.round(along_shorter_kc / along_shorter_ks * 100) / 100.0;

        Log.e("3", "calDepthOfSlab: " + along_longer_kc);
        Log.e("3", "calDepthOfSlab: " + along_longer_ks);
        Log.e("3", "calDepthOfSlab: " + along_longer_alphac);
        Log.e("3", "calDepthOfSlab: " + along_shorter_kc);
        Log.e("3", "calDepthOfSlab: " + along_shorter_ks);
        Log.e("3", "calDepthOfSlab: " + along_shorter_alphac);
    }
    ...
    private void checkForCorrection() {
        ...
        Log.e("3", "calDepthOfSlab: " + along_shorter_kc);
        Log.e("3", "calDepthOfSlab: " + along_shorter_ks);
        Log.e("3", "calDepthOfSlab: " + ratiolldl);
    }
    ...
    private void provideReinfrocement() {
        ...
        along_long_span_d2 = depth_of_drop_portion;
        ...
        along_short_span_D = depth_of_drop_portion;
        ...
        Log.e("3", "calDepthOfSlab: " + along_short_span_finalAst_col_plus);
        Log.e("3", "calDepthOfSlab: " + along_short_span_finalAst_col_minus);
        Log.e("3", "calDepthOfSlab: " + along_short_span_finalAst_mid_plus);
        Log.e("3", "calDepthOfSlab: " + along_short_span_finalAst_mid_minus);
    }
    ...
    private void checkForTwoWayShear() {
        ...
        Vu = ((interior_longer_span * interior_shorter_span) - (1)) * Factored_total_load;
        b0 = (2 * 1105) + (2 * 1105);
        tv = (Vu * 1000) / (depth_of_drop_portion * b0);
        ks = 0.5 + (880 / 880);
